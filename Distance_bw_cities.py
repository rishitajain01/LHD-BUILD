...
Label(root, text="Enter first place : " , bg = "light grey").grid(row=1, sticky=W)
Label(root, text="Enter secound place : " , bg = "light grey").grid(row=2, sticky=W)

Label(root, text="Result :", bg = "light grey").grid(row=3, sticky=W)
...
b = Button(root, text="Check", command=get_dis, bg = "white")
